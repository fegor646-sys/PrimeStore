// Довідник способів отримати Prime Coin. Як і з товарами, це лише
// СІД для першого запуску - далі все редагується в адмінці, а нові
// рядки (щоденні завдання, місії, колесо фортуни) додаються сюди ж
// без переписування коду: достатньо нової групи в EARN_SEED.
